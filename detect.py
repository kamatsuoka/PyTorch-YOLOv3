...
if __name__ == "__main__":
    ...
    parser.add_argument("--grayscale", action='store_true', help="train on grayscale images")
    ...
    dataloader = DataLoader(
        ImageFolder(opt.image_folder, img_size=opt.img_size, grayscale=opt.grayscale),
